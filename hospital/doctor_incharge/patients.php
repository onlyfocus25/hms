  ...
  <div class="container mt-5">
    ...
    <table class="table table-bordered">
      ...
      <tbody id="internalPatientsTable">
        <?php
        // Fetch internal patients data from the database and display in the table
        // Modify this query according to your database schema
        $internal_patients_sql = "SELECT * FROM internalpatient";
        // Execute the query and fetch data
        // Modify this code according to your database connection method
    ...
    <table class="table table-bordered">
      ...
      <tbody id="externalPatientsTable">
        <?php
        // Fetch external patients data from the database and display in the table
        // Modify this query according to your database schema
